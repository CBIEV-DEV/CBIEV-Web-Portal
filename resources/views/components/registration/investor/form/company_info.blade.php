...
<div class="form-group row">
    ...
    <div class="col-sm-9">
        <input type="text" name="companyRegisteredName" title="Please insert company name" placeholder="Insert company name" required="" id="companyRegisteredName" class="form-control">
    </div>
</div>
<div class="form-group row">
    <label for="companyBusinessRegNo" class="col-sm-3 col-form-label">Company Registration No<span style="color:red">*</span></label>
    <div class="col-sm-9">
        <input type="text" name="companyBusinessRegNo" pattern="[a-zA-Z0-9]+" titl="Please insert company registration number" placeholder="Insert company resgistration number" required="" id="companyBusinessRegNo" class="form-control">
    </div>
</div>
<div class="form-group row">
