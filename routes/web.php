...
Route::prefix('recommendation')->group(function(){
    Route::prefix('projectRegistration')->group(function(){
        Route::get('/rec/{type}/{recID}','RecommendationController@projectRecommendation')->name('project.recommendation.get');
        Route::post('/project/rec/post','RecommendationController@saveRecommendation')->name('project.recommendation.post');
        Route::get('/rec/manager/{type}/{recID}','RecommendationController@projectRecommendation')->name('project.recommendation.manager.get');
        Route::post('/project/rec/manager/post','RecommendationController@saveRecommendation')->name('project.recommendation.manager.post');
        Route::get('/app/director/{recID}','PRDirectorApprovalController@showApprovalForm')->name('project.approval.get');
        Route::post('/app/director/post','PRDirectorApprovalController@saveApproval')->name('project.approval.post');
    });
    Route::prefix('mentorRegistration')->group(function(){
        Route::get('/rec/{recID}','MRDeanHeadRecommendationController@showRecommendationForm')->name('mentor.recommendation.dean.head.get');
        Route::post('/rec/post','MRDeanHeadRecommendationController@saveRecommendation')->name('mentor.recommendation.dean.head.post');
        Route::get('/rec/manager/{recID}','MRManagerRecommendationController@showRecommendationForm')->name('mentor.recommendation.manager.get');
        ...
        Route::get('/app/director/{recID}','MRDirectorApprovalController@showApprovalForm')->name('mentor.approval.get');
        Route::post('/mentor/app/director/post','MRDirectorApprovalController@saveApproval')->name('mentor.approval.post');
    });
    Route::prefix('investorRegistration')->group(function(){
        Route::get('/rec/manager/{recID}','IRManagerRecommendationController@showRecommendationForm')->name('investor.recommendation.manager.get');
        Route::post('/rec/manager/post','IRManagerRecommendationController@saveRecommendation')->name('investor.recommendation.manager.post');
        Route::get('/app/director/{appID}','IRDirectorApprovalController@showApprovalForm')->name('investor.approval.get');
        Route::post('/app/director/post','IRDirectorApprovalController@saveApproval')->name('investor.approval.post');
    });  
    // success
